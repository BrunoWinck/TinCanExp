    ...
    LRS.prototype = {
        ...
        */
        init: function (cfg) {
            ...
            if (env.isBrowser) {
                ...
                this.log("Unrecognized environment not supported: (not isBrowser)" + env);
            }
        ...
        */
        saveStatement: function (stmt, cfg) {
            ...
            //       that it needs to
            if (! TinCan.environment().isBrowser) {
                this.log("error: environment not implemented, 26");
                return;
            }
        ...
        */
        retrieveStatement: function (stmtId, cfg) {
            ...
            //       that it needs to
            if (! TinCan.environment().isBrowser) {
                this.log("error: environment not implemented, 25");
                return;
            }
        ...
        */
        retrieveVoidedStatement: function (stmtId, cfg) {
            ...
            //       that it needs to
            if (! TinCan.environment().isBrowser) {
                this.log("error: environment not implemented, 24");
                return;
            }
        ...
        */
	    ...
	    if (false)
            if (! TinCan.environment().isBrowser) {
                this.log("error: environment not implemented, 23");
                return;
            }
        ...
        */
        queryStatements: function (cfg) {
            ...
            //       that it needs to
            if (! TinCan.environment().isBrowser) {
                this.log("error: environment not implemented, 22");
                return;
            }
        ...
        */
        retrieveState: function (key, cfg) {
            ...
            //       that it needs to
            if (! TinCan.environment().isBrowser) {
                this.log("error: environment not implemented, 20");
                return;
            }
        ...
        */
        saveState: function (key, val, cfg) {
            ...
            //       that it needs to
            if (! TinCan.environment().isBrowser) {
                this.log("error: environment not implemented, 19");
                return;
            }
        ...
        */
        dropState: function (key, cfg) {
            ...
            //       that it needs to
            if (! TinCan.environment().isBrowser) {
                this.log("error: environment not implemented, 18");
                return;
            }
        ...
        */
        retrieveActivityProfile: function (key, cfg) {
            ...
            //       that it needs to
            if (! TinCan.environment().isBrowser) {
                this.log("error: environment not implemented, 17");
                return;
            }
        ...
        */
        saveActivityProfile: function (key, val, cfg) {
            ...
            //       that it needs to
            if (! TinCan.environment().isBrowser) {
                this.log("error: environment not implemented, 14");
                return;
            }
        ...
        */
        dropActivityProfile: function (key, cfg) {
            ...
            //       that it needs to
            if (! TinCan.environment().isBrowser) {
                this.log("error: environment not implemented, 15");
                return;
            }
